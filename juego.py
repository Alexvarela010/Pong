...
def juego():
    ...
    while True:
        ...
        VELOCIDAD_PELOTA = manejar_colisiones_bloques(bloques1, VELOCIDAD_PELOTA, cuadrados_extra)
        VELOCIDAD_PELOTA = manejar_colisiones_bloques(bloques2, VELOCIDAD_PELOTA, cuadrados_extra)
